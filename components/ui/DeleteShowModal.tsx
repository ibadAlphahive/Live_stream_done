...
export default function DeleteShowModal({
  isOpen,
  onClose,
  onConfirm,
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex justify-center items-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl p-6 sm:p-8 relative shadow-xl">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h2 className="text-[#05004E] text-lg font-bold">Are you sure you want to delete?</h2>
          <p className="text-sm text-[#737791]">This will remove the show permanently.</p>
